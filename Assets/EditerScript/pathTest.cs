...
public class pathTest : MonoBehaviour
{
    ...
    void CleanLine()
    {
        if (transform.Find("/Canvas/Scroll View/Viewport/Content/pathLine") != null)
            Tools.DestroyImmediate(transform.Find("/Canvas/Scroll View/Viewport/Content/pathLine").gameObject);
    }
