...
public class MyCharacterController : MonoBehaviour {
    ...
    static public MyCharacterController Get(GameObject go)
    {
        MyCharacterController controller = go.GetComponent<MyCharacterController>();
        if (controller == null)
        {
            controller = go.AddComponent<MyCharacterController>();
        }
        return controller;
    }
