...
public class Character : MonoBehaviour {
    ...
    void Spawn(ArrayList List)
    {
        ...
        if (characterID != -1)
        {
            CreateCharacter(List[characterID] as CharacterInfo);
        }
        else
        {
            foreach (CharacterInfo c in List)
    ...
    void CreateCharacter(CharacterInfo c)
    {
        ...
        CharacterController.Get(_char).speed = testSpeed;
