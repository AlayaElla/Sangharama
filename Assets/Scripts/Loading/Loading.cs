...
public class Loading : MonoBehaviour {
   ...
   public struct StoryResourcePack
    {
        public ChatManager.ChatConfig NowConfig;
        public ChatManager.ChatActionBox NowStroyActionBox;
        public ChatManager.ResourcesBox NowResourcesBox;
    }
    ...
    public void LoadingStoryScene(string storyname,System.Action loadingDone)
    {
        ...
        //初始化
        storyResPack = new StoryResourcePack();
        storyResPack.NowConfig = new ChatManager.ChatConfig();
        storyResPack.NowStroyActionBox = new ChatManager.ChatActionBox();
